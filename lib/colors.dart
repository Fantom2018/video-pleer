...
class AppColor{
  ...
  static  Color gradientThird=const Color(0xFF414160);
  ...
  static  Color homePageIcons2=const Color(0xff252767);
  static const Color homePageContainerTextSmall=const Color(0xFFf4f5fd);
